...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) {
  ...
  // ambil data loket dan pelayanan dari request AJAX
  $loket = $_POST['loket'];
  ...
  // sql statement untuk insert data ke tabel "tbl_antrian" termasuk loket dan pelayanan
  $insert = mysqli_query($mysqli, "INSERT INTO tbl_antrian(tanggal, no_antrian, loket, pelayanan) 
                                   VALUES('$tanggal', '$no_antrian', '$loket', '$pelayanan')")
