        ...
        <div class="col-lg-5 mb-4">
          ...
          <div class="card border-0 shadow-sm">
            <div class="card-body text-center d-grid p-5">
              ...
              <select class="form-select mb-3" aria-label="Pilih Loket">
              ...
              <select class="form-select mb-3" aria-label="Pilih Pelayanan">
                <option selected>Pilih Pelayanan</option>
                <option value="1">Pelayanan 1</option>
                <option value="2">Pelayanan 2</option>
                <option value="3">Pelayanan 3</option>
                <!-- tambahkan opsi lain jika diperlukan -->
              </select>
  ...
  <footer class="footer mt-auto py-4">
    <div class="container">
      ...
      <div class="copyright text-center mb-2 mb-md-0">
        &copy; 2024 - <a href="" target="_blank" class="text-danger text-decoration-none">Kelompok 7</a>. Pemograman WEB 2.
      </div>
    </div>
  </footer>
